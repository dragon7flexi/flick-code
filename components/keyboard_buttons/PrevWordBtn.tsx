    ...
    const handlePress = (): void => {
        setCursorPos(
            (
                ...
                const newCursorPos: CursorPos = getPrevWordCursorPosIfMovable(
                    code,
                    prevCursorPos,
                );
