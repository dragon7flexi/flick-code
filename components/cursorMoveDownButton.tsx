...
export default function CursorMoveDownButton() {
    ...
    // HACK: commonize the long press logic between the CursorMoveDownButton and the others.
    ...
    const moveCursor = () => {
        ...
        setCursorPos((prevCursorPos: CursorPos): CursorPos => {
            const nextCursorPos: CursorPos = getDownCursorPosIfMovable(code, prevCursorPos);
